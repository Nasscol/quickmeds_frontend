...
export const batchSchema = zod.object({
  ...
  wholesaler: zod.string({ message: "Wholesaler is required" }).nonempty({ message: "Wholesaler is required" }).max(100, { message: "Wholesaler can't be more than 100 characters" }),
